    ...
    <div class="customization_cards" id="value">
        ...
        <button class="cta">
            ...
            <img src="../assets/right_arrow.svg" alt="" />
                ...
                <button class="cta leadpopup" ctaButton>Commencez Votre Personnalisation Dès Aujourd'hui <img src="<?php echo get_template_directory_uri() . '/assets/images/right_arrow.svg'; ?>" alt="" /></button>
             </div>
 </section>