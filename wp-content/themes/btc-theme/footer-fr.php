...
<section id="footer_img_frame">
    <div id="footerContact">
        ...
        <div class="content">
            <div class="heading">
                <p>Nous Contacter</p>
                <h3>Vous recherchez une Confection <br>textile transparente et évolutive?</h3>
            </div>
            <p class='footerCopy'>Nous proposons une confection de vêtements de bout en bout sous un même toit, conçue pour les marques, les détaillants et les maisons d'achat prêtes à monter en échelle.</p>
            <button  onclick="scrollToSectionById('lead_form')" class="cta leadpopup">Nous Contacter<img src="<?php echo get_template_directory_uri() . '/assets/images/right_arrow.svg'; ?>" alt=""></button>
        </div>
    </div>
</section>
