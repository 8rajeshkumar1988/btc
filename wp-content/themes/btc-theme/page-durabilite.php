    ...
    <div class="parent_pers">
        <div class="containers">
            ...
            <div class="bottom">
                ...
                <div class="right">
                    <img loading="lazy" src="<?php echo get_template_directory_uri() . '/assets/images/sustain_cotton.webp'; ?>" alt="Enraciné en Afrique">
                </div>
            </div>
        </div>
    </div>
    <div class="parent_pers">
        <div class="containers">
            ...
            <div class="bottom">
                ...
                <div class="right">
                    <img loading="lazy" src="<?php echo get_template_directory_uri() . '/assets/images/BTC-Spinning-25.jpg'; ?>" alt="Filature Plus Intelligente">
                </div>
            </div>
        </div>
    </div>
    <div class="parent_pers">
        <div class="containers">
            ...
            <div class="bottom">
                ...
                <div class="right">
                    <img loading="lazy" src="<?php echo get_template_directory_uri() . '/assets/images/BTC-Knitting-05.jpg'; ?>" alt="Tricotage de Précision, Réduction Des Déchets">
                </div>
            </div>
        </div>
    </div>
    <div class="parent_pers">
        <div class="containers">
            ...
            <div class="bottom">
                ...
                <div class="right">
                    <img loading="lazy" src="<?php echo get_template_directory_uri() . '/assets/images/dyeing.webp'; ?>" alt="Teinture à Faible Impact">
                </div>
            </div>
        </div>
    </div>
    <div class="parent_pers">
        <div class="containers">
            ...
            <div class="bottom">
                ...
                <div class="right">
                    <img loading="lazy" src="<?php echo get_template_directory_uri() . '/assets/images/Quality-control.jpg'; ?>" alt="Durable par Structure">
                </div>
            </div>
        </div>
    </div>
...
<section id="certificates_compliances">
  ...
  <div class="cc_container">
    ...
    <div class="certificate_card">
      <div class="certificate_logo">
        <img loading="lazy" src="<?php echo get_template_directory_uri() . "/assets/images/certificates/cotton_made_in_africa.webp" ?>" alt="Coton fabriqué en Afrique">
      </div>
      <div class="certificate_description">
